...
namespace CSF.DecoratorBuilder.Tests.NonAutofac
{
    ...
    public class DecoratorCustomizerAdapterTests
    {
        [Test, AutoMoqData]
        public void ThenWrapWith_executes_appropriate_functionality_from_wrapped_service([Frozen] ICustomizesAutofacDecorator wrapped,
        ...
        [Test, AutoMoqData]
        public void ThenWrapWithType_maps_and_passes_parameters([Frozen] ICustomizesAutofacDecorator wrapped,
                                                                    DecoratorCustomizerAdapter sut,
                                                                    Type aType,
                                                                    ICustomizesAutofacDecorator customiser)
        {
